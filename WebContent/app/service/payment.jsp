            ...
            <div id="cash_box">
                ...
                <ul style="margin:0; padding:0">
                    ...
                    <li>
                        ...
                        <input type="text" name="" id="cash" placeholder="0원"><button>전액사용</button>
                    </li>
                </ul>
            </div>
            <div id="pay_way">
                <p class="order_menu">결제방법</p>
                <label for="1"><input type="radio">신용카드</label>
                <label for="2"><input type="radio">무통장입금</label>
                <label for="3"><input type="radio">실시간 계좌이체</label>
                <label for="4"><input type="radio">휴대폰</label>
                <label for="5"><input type="radio">toss</label>
                <label for="6"><input type="radio">payco</label>
            </div>
            <div id="tax">
