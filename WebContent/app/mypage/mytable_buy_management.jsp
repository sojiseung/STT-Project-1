...
<c:otherwise>
   <%@ include file="/fix/header.jsp" %>
    ...
    <title>내 테이블</title>
    <link rel="stylesheet" href="${cp}/css/mytable_buy_management.css">
    <script
            ...
            <div id="right">
                <div id="right_top">
                    ...
                    <div id="input_top">
                        ...
                        onfocus="(this.type='date')"
                        onblur="(this.type='text')">
                        <input type="text" placeholder="서비스 제목" size="16">
                        <input type="submit" name="click" value="검색"></input> 
                    </div>  
                </div>
                <div id="search_box">
                    <p>내역이 없습니다!</p>
